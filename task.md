...
- [ ] **Tooling Update**
  - [ ] [MODIFY] `smoke_test.py`: Replace `print` with `logger`
  - [ ] [MODIFY] `scripts/validate.py`: Replace `print` with `logger`
- [ ] **Verification**
  - [ ] [TEST] `python inference.py --offline`: Verify compliance
  - [ ] [TEST] `pytest`: Verify internal logic
